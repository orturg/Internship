...
class CalculatorTableViewCell: UITableViewCell {
    ...
    static let reuseID = TextValues.calculatorTableViewCellReuseID
    ...
    private func setupLayoutConstraints() {
        NSLayoutConstraint.activate([
            ...
            line.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: Constants.calculatorTableViewCellLineTopAnchor),
            line.leadingAnchor.constraint(equalTo: leadingAnchor),
            line.trailingAnchor.constraint(equalTo: trailingAnchor),
            line.heightAnchor.constraint(equalToConstant: Constants.progressTableViewCellLineHeight),
            line.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -Constants.calculatorTableViewCellLineBottomAnchor)
        ])
    }
}
