...
enum Constants {
    ...
    static let chooseActivityLevelVCContainerVerticalAnchor: CGFloat = 204
    static let chooseActivityLevelVCContainerHorizontalAnchor: CGFloat = 43
    static let confirmButtonHeight: CGFloat = 50
    static let confirmButtonWidth: CGFloat = 199
    static let chooseYourActivityLevelContainerTableViewRowHeight: CGFloat = 58
    static let chooseYourActivityLevelContainerTitleLabelTopAnchor: CGFloat = 13
    static let chooseYourActivityLevelContainerTitleLabelHeightAnchor: CGFloat = 28
    static let chooseYourActivityLevelContainerTableViewTopAnchor: CGFloat = 40
    static let chooseYourActivityLevelContainerTableViewHorizontalAnchor: CGFloat = 11
    static let chooseYourActivityLevelContainerTableViewBottomAnchor: CGFloat = 100
    static let chooseYourActivityLevelContainerConfirmButtonHorizontalAnchor: CGFloat = 45
    static let chooseYourActivityLevelContainerConfirmButtonBottomAnchor: CGFloat = 20
    static let chooseActivityLevelCellTitleLabelSize: CGFloat = 16
    static let chooseActivityLevelCellRadioButtonTopAnchor: CGFloat = 4
    static let chooseActivityLevelCellTitleLabelLeadingAnchor: CGFloat = 13
    static let chooseActivityLevelCellTitleLabelTrailingAnchor: CGFloat = 25
    static let calculationViewControllerCalculatorNameLabelSize: CGFloat = 24
    static let calculationViewControllerSegmentedControlBottomAnchor: CGFloat = 16
    static let calculationViewControllerSegmentedControlHorizontalAnchor: CGFloat = 43
    static let calculationViewControllerSegmentedControlHeightAnchor: CGFloat = 35
    static let calculationViewControllerParametersStackViewSpacing: CGFloat = 16
    static let calculationViewControllerResultLabelSize: CGFloat = 28
    static let calculationViewControllerResultLabelErrorSize: CGFloat = 18
    static let calculationViewControllerDescriptionLabelSize: CGFloat = 18
    static let calculationViewControllerParametersStackViewTopAnchor: CGFloat = 25
    static let calculationViewControllerParametersStackViewHeightAnchor: CGFloat = 100
    static let calculationViewControllerFatPercentageSupermanParametersStackViewTopAnchor: CGFloat = 32
    static let calculationViewControllerFatPercentageSupermanParametersStackViewHeightAnchor: CGFloat = 158
    static let calculationViewControllerFatPercentageSuperwomanParametersStackViewHeightAnchor: CGFloat = 216
    static let calculationViewControllerParametersStackViewHorizontalAnchor: CGFloat = 41
    static let calculationViewControllerChooseActivityLevelButtonTopAnchor: CGFloat = 16
    static let calculationViewControllerChooseActivityLevelButtonHeightAnchor: CGFloat = 49
    static let calculationViewControllerResultWindowTopAnchor: CGFloat = 45
    static let calculationViewControllerResultWindowHorizontalAnchor: CGFloat = 43
    static let calculationViewControllerResultWindowHeightAnchor: CGFloat = 93
    static let calculationViewControllerCalculatorNameLabelTopAnchor: CGFloat = 132
    static let calculationViewControllerCalculatorNameLabelHorizontalAnchor: CGFloat = 55
    static let calculationViewControllerCalculateButtonHorizontalAnchor: CGFloat = 43
    static let calculationViewControllerCalculateButtonBottomAnchor: CGFloat = 48
    static let calculationViewControllerDescriptionLabelTopAnchor: CGFloat = 16
    static let calculationViewStackTitleLabelSize: CGFloat = 18
    static let calculationViewStackUnitsLabelSize: CGFloat = 18
    static let calculationViewStackTextFieldLeadingAnchor: CGFloat = 64
    static let calculationViewStackTextFieldTrailingAnchor: CGFloat = 95
    static let calculationViewStackTextFieldHeightAnchor: CGFloat = 42
    static let calculationViewStackUnitsLabelLeadingAnchor: CGFloat = 40
    static let calculatorViewControllerTableViewTopAnchor: CGFloat = 195
    static let calculatorViewControllerTableViewHorizontalAnchor: CGFloat = 43
    static let calculatorViewControllerTableViewBottomAnchor: CGFloat = 10
    static let calculatorTableViewCellLineTopAnchor: CGFloat = 16
    static let calculatorTableViewCellLineBottomAnchor: CGFloat = 24
}
